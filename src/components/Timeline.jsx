...
const MyTimeline = [
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        history:
          "学生時代に知り合った知人から声をかけられ、ホームセキュリティ機器販売を担当し、新規事業の立ち上げにも従事。\n24歳で福岡支店を開設後、25歳で会社が倒産。",
      },
      {
        key: Math.floor(Math.random() * 1e3),
        ...
        title: "【起業・経営】会社設立",
        history:
          "前職の同僚と会社を設立し、知人のコンサルティングを受けながらポイントサイトメディアを立ち上げ、運営に携わる。\nアクセス解析や運営を通じて経営を学ぶも、業績が安定せず、30歳で会社員に転職。",
      },
    ],
  },
  {
    ...
    episodes: [
      {
        ...
        history:
          "医療・福祉業界の人材派遣・紹介会社に入社し、東京本社で営業職として従事。\nその後、部門管理やビジネスモデルの見直し、新規事業の考案、基幹システム構築にも携わる。\n自分でシステム開発ができるようになりたいと強く感じ、エンジニア転職を決意。",
      },
      {
        key: Math.floor(Math.random() * 1e3),
      ...
      },
      {
        ...
        title:
          "【エンジニア】エンジニアとして転職",
        history:
          "バックエンドとフロントエンドの開発に従事。\nPHP、Javascript、MySQL、AWSなどの技術を使用。",
      },
      {
        key: Math.floor(Math.random() * 1e3),
        data: "37歳~（2022年 - 2023）",
        ...
        history:
          "エンジニアとして入社するも、クライアント対応や業務改善が主な業務となり、希望していた開発業務には十分に携われない状況が続く。\n効率化に貢献し、業務改善に取り組んだ経験は成長につながったが、開発に専念できる環境を求めて退職。",
      },
      {
        key: Math.floor(Math.random() * 1e3),
        data: "38歳~（2023年 - 現在）",
        ...
        history:
          "受託開発企業にて、業務系システムの開発に従事。\n複数のプロジェクトで様々な技術スタックを用い、バックエンド・フロントエンドの両方でシステム開発に取り組んでいる。",
      },
    ],
  },
];
